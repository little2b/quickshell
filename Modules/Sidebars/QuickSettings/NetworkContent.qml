...
WidgetPanel {
    ...
    readonly property string passwordPromptKey: NetworkService.passwordPromptActive ? JSON.stringify(
                                                                                          [NetworkService.passwordRequestDeviceName,
                                                                                           NetworkService.passwordRequestSsid]) :
                                                                                      ""
            ...
            ColumnLayout {
                ...
                SettingsSection {
                    ...
                    supportingText: root.initialLoading ? qsTr("Getting scan results") :
                                                          availableNetworkModel.count + qsTr(" networks")
                    ...
                    SettingsRow {
                        Layout.fillWidth: true
                        visible: !root.initialLoading && !root.refreshLoading && availableNetworkModel.count
                                 === 0
                        iconName: "search_off"
    ...
    component WifiNetworkItem: Rectangle {
        ...
        readonly property bool networkAskingPassword: NetworkService.passwordRequestSsid === wifiNetwork.ssid
                                                      && (NetworkService.passwordRequestDeviceName.length
                                                          === 0 || NetworkService.passwordRequestDeviceName
                                                          === wifiNetwork.deviceName)
        ...
        Item {
            ...
            ColumnLayout {
                ...
                MaterialTextField {
                    ...
                    onTextEdited: if (itemRoot.networkAskingPassword)
